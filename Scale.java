...
public class Scale {
    ...
    private int count;
    /**
     * The measurement from scale in a hash map string unit and BigInteger weight.
     * */
    private HashMap<String, BigInteger> measurement;
    ...
    public Scale(final JsonObject response) {
        ...
        if (!response.get("measurement").isJsonNull()) {
            ...
            measurement = new HashMap<String, BigInteger>();
            for (Map.Entry<String, JsonElement> measurementEntry : measurementEntries) {
                BigInteger jsonMeasurementValue = measurementEntry.getValue().getAsBigInteger();
    ...
    /**
     * @return measurement as a hashmap (key, value).
     * */
    public final HashMap<String, BigInteger> getMeasurement() {
        return measurement;
    }
	...
	public String toString() {
		return "Scale [json=" + json + ", mass=" + Arrays.toString(mass) + ", deviceName=" + deviceName + ", deviceNum="
				+ deviceNum + ", port=" + port + ", count=" + count + ", measurement=" + measurement
				+ ", clientReportedCreateTimestamp=" + clientReportedCreateTimestamp + ", ntpOffset=" + ntpOffset
				+ ", ageOfData=" + ageOfData + ", computerId=" + computerId + ", vendor=" + vendor + ", product="
